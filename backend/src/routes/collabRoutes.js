...
// Deletion workflow
router.post('/:id/request-deletion',protect,requestDeletion);
router.post('/:id/accept-deletion',protect,acceptDeletion);
router.post('/:id/reject-deletion',protect,rejectDeletion);
